            ...
            <div className="flex flex-wrap gap-4">
              ...
              {job.category && (
                <div className="flex items-center text-sm text-muted-foreground">
                  ...
                  {job.category.charAt(0).toUpperCase() + job.category.slice(1).replace(/-/g, ' ')}
                </div>
              )}
              ...
              {(job.experience || job.experienceLevel) && (
                <div className="flex items-center text-sm text-muted-foreground">
                  ...
                  {(job.experience || job.experienceLevel || "").toString().charAt(0).toUpperCase() +
                   (job.experience || job.experienceLevel || "").toString().slice(1).replace(/-/g, ' ')}
                </div>
              )}
